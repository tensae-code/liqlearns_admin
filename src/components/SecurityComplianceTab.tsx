    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Security & Compliance Monitoring</h2>
              <p className="text-gray-600">Real-time security metrics and compliance tracking</p>
            </div>
          </div>
          <button
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900">Stripe Webhook Security</h3>
        </div>
        ...
        <div className="mt-4 p-4 bg-orange-50 rounded-lg">
          <p className="text-sm text-gray-700">
            ...
            All incoming Stripe events are validated using stripe.webhooks.constructEvent.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900">Rate Limiting Controls</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <h4 className="font-semibold text-gray-900">Login Endpoint Protection</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-gray-900">API Rate Limits</h4>
            <div className="space-y-2">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-gray-900">GDPR Compliance Status</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-3">
            {[
              ...
              { label: 'Data Processing Records', status: true }
            ].map((item) => (
              <div key={item.label} className="flex items-center justify-between p-3 bg-green-50 rounded">
          ...
          <div className="space-y-3">
            {[
              { label: 'User Consent Tracking', status: true },
              { label: 'Right to Deletion', status: true },
              { label: 'Data Export', status: true }
            ].map((item) => (
              <div key={item.label} className="flex items-center justify-between p-3 bg-green-50 rounded">
                <span className="text-sm text-gray-700">{item.label}</span>
                <CheckCircle className="w-5 h-5 text-green-500" />
